...
import simple_token_abi from '../abis/simple_token_abi.json'
...
const Wallet = () => {
	...
	let contractAddress = '0x2045CC78A67955d9113076132989b3738eA4C8B8';
	...
	<div style={{backgroundColor:"#212529",minHeight:"100vh"}}>
	  ...
	  <button className={styles.button6} onClick={connectWalletHandler}>{connButtonText}</button>
        ...
        <div className="w-20 grid grid-rows-1 grid-flow-col">
          ...
          <span className="text-white block" >{tokenName}</span><span className="text-[#40fa56] "> Wallet</span>
          </div>
        </div>
          ...
          <div className=" h-auto w-3/4 flex flex-col justify-center gap-6">
            <div className=" flex flex-col w-auto">
              <span className="text-white bg-black w-full px-2 rounded-xl p-2 ">
                Wallet<span className="text-[#40fa56]"> Address</span>:{defaultAccount}
              </span>
            </div>
            <div className=" flex flex-col">
              <span className="text-white bg-black w-full px-2 rounded-xl p-2">
			  {tokenName} <span className="text-[#40fa56] "> Balance: </span>{balance}
              </span>
            </div>
          </div>
